...
public class KwitantieBoek {
    ...
    public int getKwitantienummer() {
        return kwitantienummer;
    }

    public void setKwitantienummer(int kwitantienummer) {
        this.kwitantienummer = kwitantienummer;
    }

    public String getBoekIsbn() {
        return boekIsbn;
    }

    public void setBoekIsbn(String boekIsbn) {
        this.boekIsbn = boekIsbn;
    }
}
